...
angular.module('spaApp')
  .service('CreditBalanceService',['$http','$rootScope', function($http, $rootScope) {

    this.getCreditBalance= function () {
		return $http({
				//url: $rootScope.restAPIBaseUrl + 'accounts/credit/balance',
				url:'json/credit-balance.json',
				method: 'GET',
				data: JSON.stringify({
					'sessionId':'0001',
					'rowId':'row_id',
